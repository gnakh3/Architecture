...
const Professionals = () => {
  ...
  return (
    <div className="relative mt-14 lg:flex lg:items-center lg:justify-between lg:h-[720px] lg:w-full h-170 max-md:overflow-x-hidden md:overflow-visible">
      <motion.div
      ...
      <motion.div
        ...
        className="
          w-[80vw] left-0 h-[50vh] flex justify-center items-center top-[45vh] bg-white absolute
